...
bool Spider::getIsRecursive(void) { return this->_isRecursive; }

void Spider::setIsRecursive(bool isRecursive) {
  this->_isRecursive = isRecursive;
}

int Spider::getDepthNumber(void) { return this->_depthNumber; }

void Spider::setDepthNumber(int nb) { this->_depthNumber = nb; }

std::string Spider::getPathOfDownload(void) { return this->_pathOfDownload; }

void Spider::setPathOfDownload(std::string path) {
  this->_pathOfDownload = path;
}

std::string Spider::getUrl(void) { return this->_url; }

void Spider::setUrl(std::string url) { this->_url = url; }
...
void Spider::run(void) {
  ...
  if (html.empty())
    ...
    std::cout << "Succès ! " << html.size() << " caractères reçus."
              << std::endl;
