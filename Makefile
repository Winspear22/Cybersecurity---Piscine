...
SCORPION_SRCS	= main.cpp ArgsParser.cpp FileValidator.cpp MetaDataReader.cpp ExifParser.cpp ExifParserJPEG.cpp ExifParserPNG.cpp ExifParserGIF.cpp ExifParserBMP.cpp
