...
Parser::Parser() {}
Parser::~Parser() {}
Parser::Parser(const Parser &src) { *this = src; }
...
std::set<std::string> Parser::extract_images(const std::string& html, const std::string& start_url, UrlHelper& urlHelper)
{
...
std::vector<std::string> Parser::extract_links(const std::string& html_content, const std::string& start_url, UrlHelper& urlHelper)
{
